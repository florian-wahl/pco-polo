...
CREATE TABLE IF NOT EXISTS `polo`.`users` (
  ...
  `password` VARCHAR(80) NOT NULL,
  `question_s` MEDIUMTEXT NOT NULL,
  `rep_s` VARCHAR(45) NOT NULL,
...
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (4, 'Qi', 'Beige');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (5, 'Qi', 'Purple');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (6, 'Qi', 'Blue');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (7, 'Tec', 'Green');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (8, 'Tec', 'Red');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (9, 'Tec', 'Yellow');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (10, 'Tec', 'Beige');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (11, 'Tec', 'Purple');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (12, 'Tec', 'Blue');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (13, 'Pri', 'Green');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (14, 'Pri', 'Red');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (15, 'Pri', 'Yellow');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (16, 'Pri', 'Beige');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (17, 'Pri', 'Purple');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (18, 'Pri', 'Blue');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (19, 'Lav', 'Green');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (20, 'Lav', 'Red');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (21, 'Lav', 'Yellow');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (22, 'Lav', 'Beige');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (23, 'Lav', 'Purple');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (24, 'Lav', 'Blue');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (25, 'Tut', 'Green');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (26, 'Tut', 'Red');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (27, 'Tut', 'Yellow');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (28, 'Tut', 'Beige');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (29, 'Tut', 'Purple');
INSERT INTO `polo`.`personnage` (`id_personnage`, `clan`, `couleur`) VALUES (30, 'Tut', 'Blue');
