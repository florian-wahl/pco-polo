...
INSERT INTO `polo`.`badges` (`id_badge`, `nom`, `description`) VALUES (3, 'Niveau 3', 'Vous avez fini le niveau 4');
INSERT INTO `polo`.`badges` (`id_badge`, `nom`, `description`) VALUES (4, 'Niveau 4', 'Vous avez fini le niveau 5');
