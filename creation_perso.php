        ...
        <form id="creation_perso" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
            ...
            <div id="selection_espece">
                ...
                <div id="perso-1" class="espece_perso">
                    ...
                    <p>
                        Ils habitent la planète QP66 et ceux-ci se distinguent des autres espèces grâce à leur caractère « touche à tout ».
                        Evidemment ils ne naissent pas avec toutes leurs capacités développées, mais ils ont l’habilité d’apprendre très vite,
                        bien plus que les autres espèces. Bien sûr, ils ont souvent un peu de mal par rapport aux autres espèces au début,
                        mais avec le temps ils sont capables de s’adapter et de s’améliorer énormément. Ils sont donc des travailleurs
                ...
                <div id="perso-2" class="espece_perso">
                    ...
                    <p>
                        Ceci est une espèce unique dans tout l’univers connu. Provenant de la planète HQ30, ils sont en fait une forme de
                        vie Biotechnologique. En étudiant l’histoire de leur évolution, on s’est aperçu que la technologie et les cellules
                        ont toujours été en symbiose. Personne n’a encore vraiment compris quand et comment ceci était arrivé.  Au vu de
                        leur symbiose avec la technologie, ils maîtrisent toute forme d’électronique et savent utiliser ces instruments
                ...
                <div id="perso-3" class="espece_perso">
                    ...
                    <p>
                        Ils viennent de la planète Frolix8. Ils sont une espèce assez compétitive et avec un bon esprit d’entreprenariat
                        mais jamais incorrects (ce n’est pas un hasard que le patron de l’astroport soit un Pri). Ils savent bien comment
                        et quand vendre quelque chose à quelqu’un, cette caractéristique les rend très importants pour le service commercial
                        de la compagnie.
                    </p>
                </div>
                ...
                <div id="perso-4" class="espece_perso">
                    ...
                    <p>
                        Provenant de la planète FI12, les Lav sont des grands travailleurs. Les conditions peu favorables de leur planète
                        d’origine ont permis de développer une résistance à la fatigue et une motivation jamais vue chez les autres espèces.
                        Ils n’aiment pas s’arrêter beaucoup de temps, ils aiment leur travail et ils le connaissent à la perfection.
                        Ils sont souvent un point de référence pour les autres membres de l’équipe, qui n’hésiteront pas à leur demander des conseils.
                    </p>
                </div>
